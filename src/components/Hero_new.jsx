...
const Hero = () => {
  ...
  const socialLinks = [
    ...
    { icon: Mail, label: 'Email', href: 'mailto:your.email@example.com', color: 'hover:bg-red-500 hover:text-white' }
  ]
    ...
    >
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center min-h-screen py-20"
        >
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <motion.div 
              ...
              className={`flex items-center space-x-4 p-4 rounded-2xl backdrop-blur-xl ${
            ...
            >
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className={`text-sm ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>Indonesia</span>
              </div>
              <div className="h-4 w-px bg-gray-400/30" />
              <div className="flex items-center space-x-2">
            ...
            <div className="space-y-6">
              ...
              <motion.h1
                variants={itemVariants}
                className={`text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight ${isDark ? 'text-white' : 'text-gray-900'}`}
              >
                <motion.span
                  animate={{ 
                    textShadow: isDark 
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h2 className={`text-xl sm:text-2xl lg:text-3xl font-semibold ${isDark ? 'text-gray-200' : 'text-gray-800'}`}>
                      I'm a{' '}
                      <motion.span 
            ...
            >
              {/* Primary CTA */}
              <motion.button 
                className={`group px-8 py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white rounded-2xl font-semibold text-lg relative overflow-hidden shadow-2xl`}
              ...
              {/* Secondary CTA */}
              <motion.button 
                className={`group px-8 py-4 border-2 rounded-2xl font-semibold text-lg transition-all duration-300 backdrop-blur-xl relative overflow-hidden ${
                  isDark 
          ...
          <div className="lg:col-span-4 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                {achievements.map((achievement, index) => (
                  <motion.div
                    ...
                    whileHover="hover"
                    className={`p-6 rounded-2xl backdrop-blur-xl text-center relative overflow-hidden ${
                      activeCard === index 
            ...
            >
              <div className="text-center space-y-4">
                <motion.div
                  className="w-16 h-16 mx-auto bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center"
                  animate={{
                    rotate: [0, 360]
                  }}
                  transition={{
                ...
                <motion.button
                  className="w-full py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-medium"
